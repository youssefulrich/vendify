...
export default function ParametresPage() {
  ...
  const boutiqueUrl = profile.shop_slug ? `${typeof window !== 'undefined' ? window.location.origin : 'https://vendify-qsom.vercel.app'}/b/${profile.shop_slug}` : null
  ...
  return (
    <div>
      <style>{`
        ...
        .profile-avatar { width: 64px; height: 64px; border-radius: 50%; background: linear-gradient(135deg, #f5a623, #ff7f50); display: flex; align-items: center; justify-content: center; font-size: 22px; font-weight: 800; color: #000; box-shadow: 0 4px 20px rgba(245,166,35,0.3); }
        ...
        .btn-wa-share:hover { background: rgba(37,211,102,0.15); transform: translateY(-1px); }
        .btn-open {
          display: flex; align-items: center; justify-content: center; gap: 7px;
          padding: 11px; border-radius: 12px; font-size: 13px; font-weight: 600;
          cursor: pointer; transition: all 0.15s; text-decoration: none;
          background: rgba(255,255,255,0.04); border: 1px solid rgba(255,255,255,0.08); color: #c8cdd8;
          grid-column: span 2;
        }
            ...
            {isPremium && profile.shop_slug && (
              <div className="boutique-card">
                ...
                <div className="boutique-url-box">
                  ...
                  <span className="boutique-url">{boutiqueUrl}</span>
                </div>
