...
const bottomItems = [
  { href: '/premium', icon: '⚡', label: 'Passer Premium' },
          ...
          {navItems.map(item => {
            ...
            return (
              <Link
                ...
                <span style={{
                  fontSize: 14,
                  filter: active ? 'drop-shadow(0 0 4px rgba(245,166,35,0.4))' : 'none',
                ...
                {item.href === '/commandes' && (
                  <span style={{
                    marginLeft: 'auto', background: '#f5a623', color: '#000',
            ...
            return (
              <Link key={item.href} href={item.href}
                ...
                style={{
                  ...
                  color: active ? '#f5a623' : hovered ? '#c8cdd8' : '#717a8f',
                  background: active ? 'rgba(245,166,35,0.08)' : hovered ? 'rgba(255,255,255,0.03)' : 'transparent',
          ...
          {profile?.plan === 'free' && (
            <Link href="/premium" onClick={() => setSidebarOpen(false)} style={{
              ...
              <div style={{
                ...
                color: '#000', background: 'linear-gradient(135deg, #f5a623, #ffcc6b)',
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{ flex: 1, minWidth: 0 }}>
              ...
              <div style={{ fontSize: 10, color: profile?.plan === 'premium' ? '#f5a623' : '#4a5266', marginTop: 1 }}>
                {profile?.plan === 'premium' ? '✦ Premium' : '● Plan Gratuit'}
              </div>
            </div>
            <button onClick={handleLogout}
              ...
              style={{
                color: '#3a4255', fontSize: 15, background: 'none',
