...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  const { data: profile } = await supabase
    .from('profiles').select('shop_name,full_name').eq('shop_slug', params.slug).single()
  ...
  return (
    <>
      <style>{`
        ...
        *, *::before, *::after { box-sizing:border-box; margin:0; padding:0; }
        ...
        .wa-main-btn {
          ...
          color:#fff;border-radius:14px;padding:14px 28px;
        ...
        .product-img {
          height:160px;background:linear-gradient(135deg,rgba(245,166,35,0.06),rgba(255,204,107,0.03));
        ...
        .stock-badge {
          ...
          background:rgba(8,10,15,0.8);backdrop-filter:blur(8px);
      ...
      <div className="hero">
        ...
        {waPhone && (
          <a
            href={`https://wa.me/${waPhone}?text=${encodeURIComponent(`Bonjour ! J'ai vu votre boutique Vendify et je voudrais commander 🛒`)}`}
